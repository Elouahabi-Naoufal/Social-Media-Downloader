...
def get_available_formats(url):
    ...
    try:
        # Simplified quality options that work with yt-dlp format selectors
        video_formats = [
            {'format_id': 'best[height<=1080]', 'quality': 'Best (1080p)', 'type': 'video'},
            {'format_id': 'best[height<=720]', 'quality': 'Medium (720p)', 'type': 'video'},
            {'format_id': 'best[height<=480]', 'quality': 'Low (480p)', 'type': 'video'}
        ]
        
        audio_formats = [
            {'format_id': 'bestaudio[abr>=128]', 'quality': 'Best (320k)', 'type': 'audio'},
            {'format_id': 'bestaudio[abr>=96]', 'quality': 'Medium (128k)', 'type': 'audio'},
            {'format_id': 'bestaudio[abr>=64]', 'quality': 'Low (64k)', 'type': 'audio'}
        ]
